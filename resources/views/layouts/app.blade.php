...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .sidebar-brand img { max-height: 40px; margin-right: 12px; transition: var(--transition-smooth); }
        .sidebar-brand img:hover { transform: scale(1.05); }
        .sidebar-brand h3 { color: var(--text-light); font-size: 1.1rem; font-weight: 800; margin: 0; letter-spacing: 0.5px; white-space: nowrap; }
        ...
        .sidebar-menu a:hover i { transform: scale(1.15); }
        ...
        .sidebar-menu a.active i { animation: pulse 2s infinite; }
        ...
        .sidebar-menu a i { margin-right: 12px; width: 20px; text-align: center; font-size: 1rem; transition: var(--transition-smooth); position: relative; z-index: 1; }
        .sidebar-menu a .badge { margin-left: auto; font-size: 0.65rem; padding: 3px 8px; border-radius: 15px; font-weight: 600; background: var(--warning-gradient); box-shadow: 0 2px 8px rgba(218, 165, 32, 0.4); }
        ...
        .toggle-sidebar:hover { transform: translateY(-2px); box-shadow: var(--shadow-md); }
        ...
        .notification-btn:hover { transform: translateY(-2px) scale(1.05); box-shadow: var(--shadow-md); }
        ...
        .user-info h6 { margin: 0; font-size: 0.8rem; font-weight: 700; color: var(--text-primary); transition: var(--transition-smooth); white-space: nowrap; }
        .user-info small { font-size: 0.65rem; color: var(--text-muted); font-weight: 500; transition: var(--transition-smooth); }
        ...
        .table { margin-bottom: 0; min-width: 100%; font-size: 0.85rem; }
        .table thead th {
            background: var(--primary-gradient);
            color: var(--text-light);
            border: none;
        ...
        .stat-card.primary { background: var(--forest-gradient); color: var(--text-light); border: none; box-shadow: var(--shadow-glow); }
        .stat-card.success { background: var(--success-gradient); color: var(--text-light); border: none; box-shadow: 0 0 25px rgba(107, 142, 35, 0.35); }
        .stat-card.warning { background: var(--warning-gradient); color: var(--text-light); border: none; box-shadow: 0 0 25px rgba(218, 165, 32, 0.35); }
        .stat-card.danger { background: var(--danger-gradient); color: var(--text-light); border: none; box-shadow: 0 0 25px rgba(165, 42, 42, 0.35); }
        .stat-card.info { background: var(--info-gradient); color: var(--text-light); border: none; box-shadow: 0 0 25px rgba(95, 158, 160, 0.35); }
        .stat-card h3 { font-size: 1.75rem; font-weight: 800; margin: 8px 0; }
        .stat-card h6 { font-size: 0.75rem; opacity: 0.9; text-transform: uppercase; letter-spacing: 0.5px; }
        ...
        .bg-primary { background: var(--primary-gradient) !important; color: var(--text-light) !important; box-shadow: 0 2px 8px rgba(107, 142, 35, 0.35); }
        .bg-success { background: var(--success-gradient) !important; color: var(--text-light) !important; box-shadow: 0 2px 8px rgba(107, 142, 35, 0.35); }
        .bg-warning { background: var(--warning-gradient) !important; color: white !important; box-shadow: 0 2px 8px rgba(218, 165, 32, 0.35); }
        .bg-danger { background: var(--danger-gradient) !important; color: var(--text-light) !important; box-shadow: 0 2px 8px rgba(165, 42, 42, 0.35); }
        .bg-info { background: var(--info-gradient) !important; color: var(--text-light) !important; box-shadow: 0 2px 8px rgba(95, 158, 160, 0.35); }
        .bg-secondary { background: linear-gradient(135deg, #6c757d 0%, #5a6268 100%) !important; color: var(--text-light) !important; }
        ...
        .btn-primary { background: var(--primary-gradient); color: var(--text-light); box-shadow: var(--shadow-sm); }
        .btn-primary:hover { transform: translateY(-2px); box-shadow: var(--shadow-md); }
        .btn-success { background: var(--success-gradient); color: var(--text-light); box-shadow: var(--shadow-sm); }
        .btn-success:hover { transform: translateY(-2px); box-shadow: 0 0 15px rgba(107, 142, 35, 0.4); }
        .btn-warning { background: var(--warning-gradient); color: var(--text-light); box-shadow: var(--shadow-sm); }
        .btn-info { background: var(--info-gradient); color: var(--text-light); box-shadow: var(--shadow-sm); }
        .btn-danger { background: var(--danger-gradient); color: var(--text-light); box-shadow: var(--shadow-sm); }
        .btn-outline-primary { background: transparent; border: 2px solid var(--primary-color); color: var(--primary-color); }
        .btn-outline-primary:hover { background: var(--primary-gradient); border-color: transparent; color: var(--text-light); box-shadow: var(--shadow-md); }
        ...
        .flash-message .alert-success { background: var(--success-gradient); box-shadow: 0 5px 20px rgba(107, 142, 35, 0.35); }
        .flash-message .alert-danger { background: var(--danger-gradient); box-shadow: 0 5px 20px rgba(165, 42, 42, 0.35); }
        .flash-message .alert-warning { background: var(--warning-gradient); box-shadow: 0 5px 20px rgba(218, 165, 32, 0.35); }
        ...
        .dropdown-item.text-danger:hover { background: var(--danger-gradient); color: var(--text-light); box-shadow: 0 2px 8px rgba(165, 42, 42, 0.35); }
        .dropdown-item.text-danger:hover i { color: var(--text-light); }
        .dropdown-divider { margin: 6px 0; border-top: 1px solid var(--border-light); }
        .dropdown-header { font-size: 0.75rem; font-weight: 700; color: var(--text-muted); padding: 8px 15px; }
        ...
        /* ==================== RESPONSIVE ==================== */
        @media (min-width: 1400px) { :root { --sidebar-width: 300px; } .content-area { padding: 35px; } .stat-card h3 { font-size: 2rem; } }
        @media (min-width: 992px) and (max-width: 1399px) { :root { --sidebar-width: 260px; } .content-area { padding: 25px; } }
        ...
        .dropdown-item.opacity-50 { opacity: 0.5 !important; background: rgba(0, 0, 0, 0.02); }
        .dropdown-item.opacity-50:hover { opacity: 0.7 !important; }
...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        <div class="sidebar-brand">
            ...
            @else
                <i class="bi bi-box-seam-fill fs-2" style="color: #6b8e23;"></i>
            @endif
        ...
        <div class="sidebar-menu">
            ...
            <a href="{{ route('items.user.index') }}" class="{{ request()->routeIs('items.user.*') ? 'active' : '' }}">
                <i class="bi bi-grid-3x3-gap"></i> Katalog Alat
            </a>
            @endif
            ...
            @else
                <a href="{{ route('borrowings.index') }}" class="{{ request()->routeIs('borrowings.*') && !request()->routeIs('borrowings.history') ? 'active' : '' }}">
                    ...
                    @if($pendingCount > 0)
                        <span class="badge bg-danger">{{ $pendingCount > 99 ? '99+' : $pendingCount }}</span>
                    @endif
                </a>
            @endif
    ...
    <div class="main-content" id="main-content">
        ...
        <header class="topbar">
            ...
            <div class="topbar-nav">
                ...
                <div class="dropdown">
                    <button class="notification-btn" data-bs-toggle="dropdown" title="Notifikasi" id="notificationButton">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" style="min-width: 320px;" id="notificationDropdown">
                        ...
                        @empty
                        <li><a class="dropdown-item text-center text-muted" href="#"><i class="bi bi-check-circle me-2"></i>Tidak ada notifikasi baru</a></li>
                        @endforelse
                        <li><hr class="dropdown-divider"></li>
                        <li>
                            <a class="dropdown-item text-center small fw-bold" href="{{ route('borrowings.my') }}" onclick="markAllAsRead();">
                ...
                <div class="dropdown">
                    <div class="user-dropdown" data-bs-toggle="dropdown">
                        ...
                        @else
                            <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->name ?? 'Admin') }}&background=556b2f&color=fff" 
