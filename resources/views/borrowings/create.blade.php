...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-0 fw-bold text-dark">
            <i class="bi bi-plus-circle me-2 text-primary"></i>Peminjaman Baru
        </h4>
...
<div class="row">
            ...
            <div class="card-body">
                <form action="{{ route('borrowings.store') }}" method="POST">
                    ...
                    <div class="alert alert-info">
                        ...
                        <strong>Info:</strong> Peminjaman akan berstatus <strong>Pending</strong> dan menunggu approval dari admin.
                    </div>
    ...
    <div class="col-lg-4">
            ...
            <div class="card-body">
                <div class="timeline">
                    <div class="d-flex mb-3">
                        ...
                        <div>
                            <h6 class="mb-0">Buat Peminjaman</h6>
                    ...
                    <div class="d-flex mb-3">
                        ...
                        <div>
                            <h6 class="mb-0">Approval Admin</h6>
        ...
        <div class="card border-0 shadow-sm mt-3">
            <div class="card-header bg-white border-0 py-3">
                <h6 class="mb-0 fw-bold">⚠️ Penting</h6>
            </div>
            <div class="card-body">
                <ul class="list-unstyled mb-0">
                    ...
                    <li class="mb-2">
                        <i class="bi bi-check-circle text-success me-2"></i>
                        Alat akan dikurangi stoknya setelah approved
                    </li>
                    <li>
                        <i class="bi bi-check-circle text-success me-2"></i>
                        Keterlambatan akan ditandai otomatis
                    </li>
                </ul>
            </div>
        </div>
